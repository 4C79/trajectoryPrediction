...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(611, 495)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(110, 370, 91, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "选定文件"))
        self.label.setText(_translate("MainWindow", "Display"))
        self.pushButton_2.setText(_translate("MainWindow", "检测轨迹"))
        self.pushButton_3.setText(_translate("MainWindow", "kanlman演示"))
